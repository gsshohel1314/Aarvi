...
class RecycleController extends Controller{
    ...
    public function videoCategory(){
        return view('admin.recycle.video_category');
    }
    ...
    public function teamCategory(){
        return view('admin.recycle.team-category');
    }
    ...
    public function partnerCategory(){
        return view('admin.recycle.partner-category');
    }
    ...
    public function projecttype(){
        return view('admin.recycle.project_type');
    }
    
    public function project(){
        return view('admin.recycle.project');
    }
    
    public function about(){
        return view('admin.recycle.about');
    }
    
    public function career(){
        return view('admin.recycle.career');
    }
}
