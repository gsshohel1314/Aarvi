          ...
          <div class="card">
              ...
              <div class="card-body card_form">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('subtitle') ? ' has-error' : '' }}">
                    <label class="col-sm-3 control-label">Event Subtitle:<span class="req_star">*</span></label>
                    <div class="col-sm-7">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('start') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="starTime" name="start" value="{{old('start')}}">
                      @if ($errors->has('start'))
                          <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('end') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="endTime" name="end" value="{{old('end')}}">
                      @if ($errors->has('end'))
                          <span class="invalid-feedback" role="alert">
