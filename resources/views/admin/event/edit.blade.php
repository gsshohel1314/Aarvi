          ...
          <div class="card">
              ...
              <div class="card-body card_form">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('date') ? ' has-error' : '' }}">
                    <label class="col-sm-3 control-label">Event Date:<span class="req_star">*</span></label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="date" id="datePick" value="{{$data->event_date}}">
                      @if ($errors->has('date'))
                          <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('start') ? ' has-error' : '' }}">
                    <label class="col-sm-3 control-label">Event Starting Time:<span class="req_star">*</span></label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="starTime" name="start" value="{{$data->event_start}}">
                      @if ($errors->has('start'))
                          <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('end') ? ' has-error' : '' }}">
                    <label class="col-sm-3 control-label">Event Ending Time:<span class="req_star">*</span></label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="endTime" name="end" value="{{$data->event_end}}">
                      @if ($errors->has('end'))
                          <span class="invalid-feedback" role="alert">
