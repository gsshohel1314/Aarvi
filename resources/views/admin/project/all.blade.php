            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/project/add')}}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-plus-circle"></i> Add Project</a>
                    </div>
                            ...
                            <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($data->image!='')
                                                <img class="table_image_50bl" src="{{asset('uploads/project/'.$data->image)}}" alt="image"/>
                                            @else
                                                <img class="table_image_50bl" src="{{asset('uploads')}}/no-image-big.jpg" alt="image"/>
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{url('dashboard/project/view/'.$data->id)}}" title="view"><i class="fa fa-plus-square fa-lg view_icon"></i></a>

                                            <a href="{{url('dashboard/project/edit/'.$data->id)}}" title="edit"><i class="fa fa-pencil-square fa-lg edit_icon"></i></a>
