    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> View Fund Information</h3>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <table class="table table-bordered table-striped table-hover custom_view_table">
                            ...
                            <tr>
                                <td>Fundraise Details</td>
                                <td>:</td>
                                <td>{!! $data->fun_details !!}</td>
                            </tr>
                            <tr>
                                <td>Image</td>
                                <td>:</td>
                                <td>
                                    @if($data->image!='')
                                        <img class="table_image_ban_big" src="{{asset('uploads/fund/'.$data->image)}}" alt="image"/>
                                    @else
