    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> All Cause Information</h3>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/cause/add')}}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-plus-circle"></i> Add Cause</a>
                    </div>
                    ...
                    <div class="col-md-7">
                        @if(Session::has('success_soft'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Successfully!</strong> delete cause information.
                          </div>
                        @endif
                            ...
                            <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($data->image!='')
                                                <img class="table_image_50bl" src="{{asset('uploads/cause/'.$data->image)}}" alt="image"/>
                                            @else
                                                <img class="table_image_50bl" src="{{asset('uploads')}}/no-image-big.jpg" alt="image"/>
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{url('dashboard/cause/view/'.$data->id)}}" title="view"><i class="fa fa-plus-square fa-lg view_icon"></i></a>

                                            <a href="{{url('dashboard/cause/edit/'.$data->id)}}" title="edit"><i class="fa fa-pencil-square fa-lg edit_icon"></i></a>
...
<div id="softDelModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content p-0 b-0">
            <form method="post" action="{{url('dashboard/cause/softdelete')}}"/>
              @csrf
              <div class="card mb-0">
                <div class="card-header">
