...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{url('dashboard/award/submit')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
              <div class="card-header">
                  <div class="row">
                      <div class="col-md-8">
                          <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> Add Award Information</h3>
                      </div>
              ...
              <div class="card-body card_form">
                    ...
                    <div class="col-md-7">
                        @if(Session::has('success'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Successfully!</strong> upload award information.
                          </div>
                        @endif
                ...
                <div class="form-group row custom_form_group{{ $errors->has('start') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="start" id="start_date" value="{{old('start')}}">
                      @if ($errors->has('start'))
                          <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('end') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="end" id="end_date" value="{{old('end')}}">
                      @if ($errors->has('end'))
                          <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group row custom_form_group">
                    ...
                    <div class="col-sm-7">
                      <textarea class="form-control" id="codeEditor" name="details" rows="9">{{old('details')}}</textarea>
                    </div>
                </div>
