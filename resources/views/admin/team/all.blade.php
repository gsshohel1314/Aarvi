                        ...
                        <div class="table-responsive">
                            <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$data->name}}</td>
                                        <td>{{(!empty($data->teamCate))?$data->teamCate->tcate_name:''}}</td>
                                        <td>{{$data->designation}}</td>
                                        <td>{{$data->email}}</td>
                                        <td>{{$data->bloodgroup->name}}</td>
                                        
                                        @if ($data->blood_donor == 1)
                                        <td>Yes</td>
                                        @else
                                        <td>no</td>
                                        @endif
                                        ...
                                        <td>
                                            @if($data->image!='')
                                                <img class="table_image_50bl" src="{{asset('uploads/team/'.$data->image)}}" alt="image"/>
                                            @else
                                                <img class="table_image_50bl" src="{{asset('uploads')}}/no-image-big.jpg" alt="image"/>
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{url('dashboard/team/view/'.$data->id)}}" title="view"><i class="fa fa-plus-square fa-lg view_icon"></i></a>
                                            <a href="{{url('dashboard/team/edit/'.$data->id)}}" title="edit"><i class="fa fa-pencil-square fa-lg edit_icon"></i></a>
