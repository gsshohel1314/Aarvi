          ...
          <div class="card">
              ...
              <div class="card-body card_form">
                    ...
                    <div class="col-sm-7">
                      <select class="form-control" name="tcate_id">
                          ...
                          @foreach($teamCategories as $value)
                            <option value="{{$value->tcate_id}}">{{$value->tcate_name}}</option>
                          @endforeach
                      </select>
                ...
                <div class="form-group row custom_form_group{{ $errors->has('t_name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="t_name" value="{{old('t_name')}}">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('blood_donor') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        <input type="radio" id="yes" name="blood_donor" value="1">
                        <label for="yes">Yes</label><br>
                        <input type="radio" id="no" name="blood_donor" value="0">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('membership_status') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        <input type="radio" id="active" name="membership_status" value="1">
                        <label for="active">Active</label><br>
                        <input type="radio" id="inactive" name="membership_status" value="0">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('start_date') ? ' has-error' : '' }}">
                    <label class="col-sm-3 control-label">Membership start date<span class="req_star">*</span></label>
                    <div class="col-sm-4" >
