...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{url('dashboard/about/update')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
              <div class="card-header">
                  <div class="row">
                      <div class="col-md-8">
                          <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> Update About Information</h3>
                      </div>
              ...
              <div class="card-body card_form">
                    ...
                    <div class="col-md-7">
                        @if(Session::has('success'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Successfully!</strong> update about information.
                          </div>
                        @endif
                ...
                <div class="form-group row custom_form_group">
                    ...
                    <div class="col-sm-2">
                        @if($data->video_image!='')
                            <img class="img-thumbnail" src="{{asset('uploads/about/'.$data->video_image)}}" alt="photo"/>
                        @else
