...
<div class="row">
    ...
    <div class="col-md-6 col-xl-3">
        <a href="{{url('dashboard/recycle/partner/category')}}">
          <div class="mini-stat clearfix bx-shadow bg-white">
              <span class="mini-stat-icon bg-primary"><i class="md md-view-carousel"></i></span>
              <div class="mini-stat-info text-right text-dark mini_stat_info">
                  @php
                      $totalPartnerCategory=App\PartnerCategory::where('pcate_status',0)->count();
                  @endphp
                  <span class="counter text-dark">{{$totalPartnerCategory}}</span>
                  Partner Category
              </div>
          </div>
        </a>
    ...
    <div class="col-md-6 col-xl-3">
        <a href="{{url('dashboard/recycle/team')}}">
          <div class="mini-stat clearfix bx-shadow bg-white">
              ...
              <div class="mini-stat-info text-right text-dark mini_stat_info">
                  @php
                      $totalTeam=App\Team::where('status',0)->count();
                  @endphp
    ...
    <div class="col-md-6 col-xl-3">
        <a href="{{url('dashboard/recycle/team/category')}}">
          <div class="mini-stat clearfix bx-shadow bg-white">
              <span class="mini-stat-icon bg-primary"><i class="md md-view-carousel"></i></span>
              <div class="mini-stat-info text-right text-dark mini_stat_info">
                  @php
                      $totalTeamCategory=App\TeamCategory::where('tcate_status',0)->count();
                  @endphp
                  <span class="counter text-dark">{{$totalTeamCategory}}</span>
                  Team Category
              </div>
          </div>
        </a>
    ...
    <div class="col-md-6 col-xl-3">
        <a href="{{url('dashboard/recycle/video/category')}}">
          <div class="mini-stat clearfix bx-shadow bg-white">
              <span class="mini-stat-icon bg-primary"><i class="md md-play-circle-fill"></i></span>
              <div class="mini-stat-info text-right text-dark mini_stat_info">
                  @php
                      $totalVideoCategory=App\VideoCategory::where('status',0)->count();
                  @endphp
                  <span class="counter text-dark">{{$totalVideoCategory}}</span>
                  Video Category
              </div>
          </div>
        </a>
    ...
    <div class="col-md-6 col-xl-3">
        <a href="{{url('dashboard/recycle/projecttype')}}">
          <div class="mini-stat clearfix bx-shadow bg-white">
              <span class="mini-stat-icon bg-primary"><i class="md md-receipt"></i></span>
              <div class="mini-stat-info text-right text-dark mini_stat_info">
                  @php
                      $totalProjectType=App\Projecttype::where('status',0)->count();
                  @endphp
                  <span class="counter text-dark">{{$totalProjectType}}</span>
                  Project Type
              </div>
          </div>
        </a>
    ...
    <div class="col-md-6 col-xl-3">
        <a href="{{url('dashboard/recycle/project')}}">
          <div class="mini-stat clearfix bx-shadow bg-white">
              ...
              <div class="mini-stat-info text-right text-dark mini_stat_info">
                  @php
                      $totalProject=App\Project::where('status',0)->count();
                  @endphp
    ...
    <div class="col-md-6 col-xl-3">
        <a href="{{url('dashboard/recycle/about')}}">
          <div class="mini-stat clearfix bx-shadow bg-white">
              <span class="mini-stat-icon bg-primary"><i class="md md-receipt"></i></span>
              <div class="mini-stat-info text-right text-dark mini_stat_info">
                  @php
                      $totalAbout=App\About::where('status',0)->count();
                  @endphp
                  <span class="counter text-dark">{{$totalAbout}}</span>
                  About
              </div>
          </div>
        </a>
    ...
    <div class="col-md-6 col-xl-3">
        <a href="{{url('dashboard/recycle/career')}}">
          <div class="mini-stat clearfix bx-shadow bg-white">
              <span class="mini-stat-icon bg-primary"><i class="md md-receipt"></i></span>
              <div class="mini-stat-info text-right text-dark mini_stat_info">
                  @php
                      $totalCareer=App\Career::where('status',0)->count();
                  @endphp
                  <span class="counter text-dark">{{$totalCareer}}</span>
                  Career
              </div>
          </div>
        </a>
