          ...
          <div class="card">
              ...
              <div class="card-body card_form">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('title') ? ' has-error' : '' }}">
                    <label class="col-sm-3 control-label">Image Title:<span class="req_star">*</span></label>
                    <div class="col-sm-7">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('cate') ? ' has-error' : '' }}">
                    <label class="col-sm-3 control-label">Image Category:<span class="req_star">*</span></label>
                    <div class="col-sm-7">
