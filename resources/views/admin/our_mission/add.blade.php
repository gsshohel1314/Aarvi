...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{url('dashboard/mission/submit')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
              <div class="card-header">
                  <div class="row">
                      <div class="col-md-8">
                          <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> Add Mission Information</h3>
                      </div>
                      <div class="col-md-4 text-right">
                          <a href="{{url('dashboard/mission')}}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-th"></i> All Mission</a>
                      </div>
              ...
              <div class="card-body card_form">
                    ...
                    <div class="col-md-7">
                        @if(Session::has('success'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Successfully!</strong> add mission information.
                          </div>
                        @endif
                ...
                <div class="form-group row custom_form_group{{ $errors->has('logo') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-4">
                      ...
                      @endif
                      <img id='img-upload'/ style="background-color: gray">
                    </div>
                </div>
              </div>
